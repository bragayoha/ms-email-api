 ...
 */
export declare type ICalDateTimeValue = Date | Moment | MomentTZ | Dayjs | LuxonDateTime | string;
...
export declare enum ICalEventRepeatingFreq {
    SECONDLY = "SECONDLY",
    MINUTELY = "MINUTELY",
    HOURLY = "HOURLY",
    DAILY = "DAILY",
...
export declare enum ICalWeekday {
    SU = "SU",
    MO = "MO",
    TU = "TU",
    WE = "WE",
